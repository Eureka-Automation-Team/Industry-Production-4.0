        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreationDate = table.Column<DateTime>(type: "datetime2(7)", nullable: false),
                    CreatedBy = table.Column<int>(type: "int", nullable: false),
                    EnableFlag = table.Column<bool>(type: "bit", nullable: false),
                    ActiveFlag = table.Column<bool>(type: "bit", nullable: false),
                    MacType = table.Column<string>(type: "nvarchar(50)", nullable: true),
                    MacGroup = table.Column<string>(type: "nvarchar(50)", nullable: true),
                    ProductionLine = table.Column<string>(type: "nvarchar(50)", nullable: true),
                    PlantId = table.Column<string>(type: "nvarchar(50)", nullable: true),
                    MachineModel = table.Column<string>(type: "nvarchar(50)", nullable: true),
                    CalendarId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MachinesMaster", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ShiftName = table.Column<string>(type: "nvarchar(50)", nullable: true),
                    ...
                    WorkingHr = table.Column<int>(type: "int", nullable: false),
                    WorkingMin = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MachineWorkings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MachineWorkings_MachinesMaster_MachineId",
                        column: x => x.MachineId,
                        principalTable: "MachinesMaster",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShelfLocations_JobTasks_TaskEntityId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TaskTransactionLogs", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TaskTransactionLogs_JobTasks_TaskEntityId",
                        column: x => x.TaskEntityId,
                        principalTable: "JobTasks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MachineWorkings_MachineId",
                table: "MachineWorkings",
                column: "MachineId");

            migrationBuilder.CreateIndex(
                name: "IX_ShelfLocations_TaskEntityId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskTransactionLogs_TaskEntityId",
                table: "TaskTransactionLogs",
                column: "TaskEntityId");
        }
